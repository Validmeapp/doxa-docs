...
Usa tu clave privada (descargada durante el onboarding) para desencriptar el payload. Consulta los ejemplos de desencriptación en [Getting Started](/es/docs/v1/developer-guide/getting-started).
...
- [Referencia de API](/es/docs/v1/developer-guide/api-reference)
