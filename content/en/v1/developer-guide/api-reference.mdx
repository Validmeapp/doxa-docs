...
```
✓ PENDING - You can cancel
✓ CONFIRMED - You can cancel
✗ SENDING - You cannot cancel
✗ SUCCESS - You cannot cancel (completed)
✗ FAILED - Already cancelled
✗ REJECTED - Already cancelled
✗ EXPIRED - Already cancelled
```
...
- ✓ Store request `_id` in your database
- ✓ Use `metadata` for internal references
- ✓ Implement retry logic with exponential backoff

### ❌ DON'T

- ✗ Don't expose API Token in frontend
- ✗ Don't make requests in loops without delay
- ✗ Don't ignore error webhooks
...
- [Webhooks Reference](/en/docs/v1/developer-guide/api-reference/webhooks)
- [Error Codes](/en/docs/v1/developer-guide/api-reference/errors)
- [Security Guide](/en/docs/v1/developer-guide/security/encryption)
